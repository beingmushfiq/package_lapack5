...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('reusable_sections', function (Blueprint $table) {
            ...
            $table->string('type'); // section type (hero_slider, product_grid, etc.)
            $table->text('description')->nullable();
            $table->string('thumbnail')->nullable();
            $table->json('components')->nullable(); // component props config
            $table->json('styles')->nullable();     // style config
